...
## 2. Short Description / Tagline (max 80 chars)

**Primary** (recommended):
```
Daily SOL tournaments built for Seeker phones
```
(45 chars)

**Alternatives:**
```
Tap. Play. Win SOL. Built for Seeker.
```
(38 chars)

```
The first daily-routine arcade for Solana Mobile
```
(50 chars)
...
## 7. Marketing Quotes (for tweets / dApp Store featured listings)
