        ...
        <View style={styles.modalBackdrop}>
          <View style={styles.privacyModalContent}>
            ...
            <ScrollView style={styles.privacyScroll} showsVerticalScrollIndicator={false}>
              ...
              <Text style={styles.privacyBullet}>• <Text style={{ fontWeight: '600' }}>Request data deletion</Text> — email us at ads@seekerquest.league with your device ID. We will delete your records within 30 days. Note: on-chain transactions cannot be deleted.</Text>
              ...
              <Text style={styles.privacyPara}>Questions about this policy: ads@seekerquest.league</Text>
