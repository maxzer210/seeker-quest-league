...
**Путь:** `D:\sk\android\app\build\outputs\apk\release\app-release.apk`
**Копия для submission:** `D:\sk\dapp-store\media\app-release.apk`
...
## 🖼 АССЕТЫ — все в `D:\sk\dapp-store\media\`
...
npx dapp-store --apk-file D:\sk\dapp-store\media\app-release.apk --whats-new "🚀 v1.0.0 — Genesis Pre-Season Launch · 7 mini-games · Real SOL on mainnet · Founder Pass tiers · P2P transfers · 5 languages"
```

### Если что-то сломалось на form:
- Помоги заполнить недостающие поля (тексты сверху ↑)
- Если просит файлы — указывай пути в `D:\sk\dapp-store\media\`
